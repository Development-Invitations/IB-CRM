...
export type NotificationSoundId = 'chime' | 'pop' | 'marimba' | 'bell' | 'double-beep';

export const NOTIFICATION_SOUND_IDS: NotificationSoundId[] = ['chime', 'pop', 'marimba', 'bell', 'double-beep'];
